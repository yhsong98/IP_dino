...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_dir', type=str, default='images/cat_face/', help='The root dir of image sets.')
    parser.add_argument('--save_dir', type=str, default='images/co_segmentation/cat_face/', help='The root save dir for image sets results.')
    parser.add_argument('--load_size', default=256, type=int, help='load size of the input images. If None maintains'
