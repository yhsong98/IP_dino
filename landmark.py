...
def show_similarity_interactive(image_path_a: str, image_folder_path_b: str, num_ref_points: int, load_size: int = 224, layer: int = 11,
    ...
    for image_path in sorted(os.listdir(image_folder_path_b)):
        ...
        np.savetxt('landmarks.csv', ptses, delimiter=',')
...
def check_sequence_direction(sequence1, sequence2, threshold=0.9):
    """
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        show_similarity_interactive(args.image_a, args.image_b_folder, args.num_ref_points, args.load_size, args.layer, args.facet, args.bin,
