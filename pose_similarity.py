...
if __name__ == "__main__":
    ...
    parser.add_argument('--image_a', type=str, default="images/forcep1.png", help='Path to the first image')
    parser.add_argument('--image_b', type=str, default="images/forcep2.png", help='Path to the second image.')
