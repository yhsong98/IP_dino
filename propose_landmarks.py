...
if __name__ == "__main__":
    ...
    parser.add_argument('--image_a', type=str, default="images/landmark_files/cat_5.jpg", help='Path to the first image')
    parser.add_argument('--image_b_folder', type=str, default="images/cat_face/", help='Path to the second image.')
    ...
    parser.add_argument('--landmark_file', default='images/landmark_files/cat_5_mask.png', type=str, help="landmarks file.")
